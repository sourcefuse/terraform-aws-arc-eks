...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_alb_ingress_eks_node_group"></a> [alb\_ingress\_eks\_node\_group](#module\_alb\_ingress\_eks\_node\_group) | cloudposse/eks-node-group/aws | 0.26.0 |
...
| <a name="input_eks_cluster_identity_oidc_issuer_arn"></a> [eks\_cluster\_identity\_oidc\_issuer\_arn](#input\_eks\_cluster\_identity\_oidc\_issuer\_arn) | OIDC Issuer ARN. | `list(string)` | n/a | yes |
...
| <a name="input_tags"></a> [tags](#input\_tags) | Tags to assign the resources. | `any` | n/a | yes |
