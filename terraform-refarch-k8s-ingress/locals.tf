...
#  default_alb_hostname     = substr(split(".", local.default_ingress_hostname)[0], 0, 32)  // TODO - remove if we dont need this. I think it was constrained by the 32 character limit to be used with other tasks.
