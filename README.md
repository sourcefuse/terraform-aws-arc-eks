...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cluster_autoscaler_helm"></a> [cluster\_autoscaler\_helm](#module\_cluster\_autoscaler\_helm) | git::https://github.com/lablabs/terraform-aws-eks-cluster-autoscaler | v2.0.0 |
